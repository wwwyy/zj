<template>
  <div id="overtimeManagement">
    <Form :model="formItem" :label-width="80" inline style="text-align:left;">
        <FormItem label="申请人工号">
            <Input v-model="formItem.input" placeholder="请输入工号" style="width:150px;"></Input>
        </FormItem>
        <FormItem label="申请人姓名">
            <Input v-model="formItem.input" placeholder="请输入姓名" style="width:150px"></Input>
        </FormItem>
       ...
       <FormItem label="提交时间">
        ...
        <br>
        <FormItem label="申请部门">
            <Select v-model="formItem.select1" style="width:150px">
